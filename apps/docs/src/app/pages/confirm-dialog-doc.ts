  ...
  template: `
    ...
    >
      ...
      >
        ...
        <div code>
          private confirm = inject(DynamoConfirmService); const ok = await
        ...
        <table class="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr class="border-b border-border">
              ...
              <td class="py-2">
                Shows a confirm prompt. Resolves
                <code class="font-mono">true</code> on confirm,
                <code class="font-mono">false</code> otherwise. Queues if one is
                already showing.
              </td>
            </tr>
            <tr class="border-b border-border">
              ...
              <td class="py-2">Confirms the currently-showing prompt.</td>
            </tr>
            <tr>
              <td class="py-2 pr-4 font-mono">cancel</td>
              <td class="py-2 pr-4 font-mono">() =&gt; void</td>
              <td class="py-2">Cancels the currently-showing prompt.</td>
            </tr>
          </tbody>
        </table>
