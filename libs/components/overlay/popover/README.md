...
| `focusOnShow`          | `boolean`               | `true`           | Moves focus into the panel (and traps it there) once shown. Set `false` to leave focus on the trigger — e.g. for a purely informational popover the user isn't expected to interact with. |
