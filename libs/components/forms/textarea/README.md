...
| `rows`        | `number`              | `3`         |                                                                                                                                                                                                                     |
| `autoResize`  | `boolean`             | `false`     | Grows the textarea's height to fit its content, up to the element's CSS `max-height`. Once content exceeds `max-height`, the element becomes internally scrollable rather than clipping.                            |
