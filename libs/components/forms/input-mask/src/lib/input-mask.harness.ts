...
/** Refactor-safe interaction API for DynamoInputMask, for use in consumer app tests. */
export class DynamoInputMaskHarness extends ComponentHarness {
  static hostSelector = 'dg-input-mask';
