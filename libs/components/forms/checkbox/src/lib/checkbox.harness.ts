...
/** Refactor-safe interaction API for DynamoCheckbox, for use in consumer app tests. */
export class DynamoCheckboxHarness extends ComponentHarness {
  static hostSelector = 'dg-checkbox';
