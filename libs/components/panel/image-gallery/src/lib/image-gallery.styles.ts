...
export const imageGalleryMainButtonStyles =
  'block h-full w-full cursor-zoom-in focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2';
...
export const imageGalleryThumbnailStyles = cva(
  'h-14 w-14 shrink-0 overflow-hidden rounded-md ring-offset-2 transition-all ' +
...
export const imageGalleryLightboxBackdropStyles = 'fixed inset-0 z-50 bg-surface-900/90';
...
export const imageGalleryLightboxPrevArrowStyles =
  'absolute left-4 top-1/2 z-10 -translate-y-1/2 h-10 w-10 rounded-full p-0 shadow-md';
export const imageGalleryLightboxNextArrowStyles =
  'absolute right-4 top-1/2 z-10 -translate-y-1/2 h-10 w-10 rounded-full p-0 shadow-md';
