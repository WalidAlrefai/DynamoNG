...
export const treeTableSortIconStyles = cva('shrink-0 transition-transform duration-150 ease-out', {
  variants: {
    direction: {
...
export const treeTableRowStyles = cva('border-b border-border last:border-b-0', {
  variants: {
    active: {
      true: 'bg-surface-100',
      false: '',
...
export const treeTableChevronButtonStyles = 'flex h-4 w-4 shrink-0 items-center justify-center';

// Copied from Tree's own treeChevronStyles shape.
export const treeTableChevronStyles = cva('shrink-0 transition-transform duration-200 ease-out', {
  variants: {
    expanded: {
      true: 'rotate-180',
      false: '',
...
export const treeTableChevronPlaceholderStyles = 'inline-block h-4 w-4 shrink-0';
